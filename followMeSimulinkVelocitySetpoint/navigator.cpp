...
void navigator_step(void)
{
  ...
  real_T rtb_Py_a;
  int16_T i;
  real_T rtb_Gain_k_idx;
  real_T rtb_Gain_k_idx_0;
   ...
   */
  rtb_Gain_k_idx = rtb_Px_h / navigator_P.Constant4_Value;

  /* Rounding: '<S13>/Rounding Function1' */
  if (rtb_Gain_k_idx < 0.0) {
    rtb_Gain_k_idx = ceil(rtb_Gain_k_idx);
  } else {
    rtb_Gain_k_idx = floor(rtb_Gain_k_idx);
  }
   ...
   *  Rounding: '<S13>/Rounding Function1'
   */
  rtb_Px_h -= navigator_P.Gain3_Gain * rtb_Gain_k_idx;

  /* Product: '<S13>/Product' incorporates:
   *  Constant: '<S13>/Constant1'
   */
  rtb_Sum1_n = rtb_Px_h / navigator_P.Constant1_Value;

  /* Rounding: '<S13>/Rounding Function' */
  if (rtb_Sum1_n < 0.0) {
    rtb_Gain_k_idx = ceil(rtb_Sum1_n);
  } else {
    rtb_Gain_k_idx = floor(rtb_Sum1_n);
  }
   ...
   *  Rounding: '<S13>/Rounding Function'
   */
  rtb_Px_h = (rtb_Px_h - navigator_P.Gain_Gain_f * rtb_Gain_k_idx) - rtb_Sum1_n *
    rt_remd_snf(rtb_Px_h, navigator_P.Constant3_Value);
   ...
   */
  rtb_Gain_k_idx = rtb_SinCos_o1 / navigator_P.Constant_Value_c;
   ...
   *  Rounding: '<S14>/Rounding Function'
   */
  rtb_SinCos_o1 -= navigator_P.Gain_Gain_h * rtb_Gain_k_idx;

  /* Gain: '<S16>/Unit Conversion' incorporates:
   *  Constant: '<S12>/initial_pos'
   *  Sum: '<S12>/Sum1'
   */
  rtb_Gain_k_idx = (rtb_Px_h - navigator_P.initial_pos_Value[0]) *
    navigator_P.UnitConversion_Gain;
  rtb_Gain_k_idx_0 = (rtb_SinCos_o1 - navigator_P.initial_pos_Value[1]) *
    navigator_P.UnitConversion_Gain;
   ...
   */
  rtb_SinCos_o1 = rtb_Gain_k_idx / rt_atan2d_snf(navigator_P.Constant2_Value_o,
    (navigator_P.Constant_Value_b - rtb_SinCos_o1 * rtb_SinCos_o1) * rtb_dEast /
    rtb_Px_h);
  ...
  rtb_dEast = 1.0 / rt_atan2d_snf(navigator_P.Constant3_Value_j, rtb_dEast * cos
                                  (rtb_Sum1_n)) * rtb_Gain_k_idx_0;

  /* Product: '<S15>/y*sin' */
  rtb_ysin = rtb_dEast * rtb_Px_h;

  /* Product: '<S15>/x*sin' */
  rtb_Sum1_n = rtb_SinCos_o1 * rtb_Px_h;
   ...
   */
  rtb_Gain_k_idx = rtb_SinCos_o1 / navigator_P.Constant4_Value_g;
   ...
   *  Rounding: '<S24>/Rounding Function1'
   */
  rtb_SinCos_o1 -= navigator_P.Gain3_Gain_o * rtb_Gain_k_idx;

  /* Product: '<S24>/Product' incorporates:
   *  Constant: '<S24>/Constant1'
   */
  rtb_Px_h = rtb_SinCos_o1 / navigator_P.Constant1_Value_d;

  /* Rounding: '<S24>/Rounding Function' */
  if (rtb_Px_h < 0.0) {
    rtb_Gain_k_idx = ceil(rtb_Px_h);
  } else {
    rtb_Gain_k_idx = floor(rtb_Px_h);
  }
   ...
   *  Rounding: '<S24>/Rounding Function'
   */
  rtb_SinCos_o1 = (rtb_SinCos_o1 - navigator_P.Gain_Gain_k * rtb_Gain_k_idx) -
    rtb_Px_h * rt_remd_snf(rtb_SinCos_o1, navigator_P.Constant3_Value_c);
   ...
   *  Sum: '<S24>/Sum3'
   */
  rtb_DotProduct = rt_remd_snf((real_T)(rtb_Px_h != 0.0) *
    navigator_P.Gain4_Gain_i + rtb_DataTypeConversion1[10],
    navigator_P.Constant2_Value_h);

  /* Product: '<S25>/Product' incorporates:
   *  Constant: '<S25>/Constant'
   */
  rtb_Gain_k_idx = rtb_DotProduct / navigator_P.Constant_Value_k;
   ...
   *  Rounding: '<S25>/Rounding Function'
   */
  rtb_DotProduct -= navigator_P.Gain_Gain_kt * rtb_Gain_k_idx;

  /* Gain: '<S27>/Unit Conversion' incorporates:
   *  Constant: '<S23>/initial_pos'
   *  Sum: '<S23>/Sum1'
   */
  rtb_Gain_k_idx = (rtb_SinCos_o1 - navigator_P.initial_pos_Value_h[0]) *
    navigator_P.UnitConversion_Gain_g;
  rtb_Gain_k_idx_0 = (rtb_DotProduct - navigator_P.initial_pos_Value_h[1]) *
    navigator_P.UnitConversion_Gain_g;
   ...
   *  Constant: '<S32>/f'
   */
  rtb_DotProduct = navigator_P.f_Value_j - navigator_P.Constant_Value_n;
   ...
   *  Sum: '<S33>/Sum1'
   */
  rtb_DotProduct = sqrt(navigator_P.Constant_Value_m - rtb_DotProduct *
                        rtb_DotProduct);
   ...
   */
  rtb_Px_h = navigator_P.Constant_Value_ks - rtb_DotProduct * rtb_DotProduct *
    rtb_Px_h * rtb_Px_h;
   ...
   */
  rtb_DotProduct = rtb_Gain_k_idx / rt_atan2d_snf(navigator_P.Constant2_Value_n,
    (navigator_P.Constant_Value_f - rtb_DotProduct * rtb_DotProduct) * rtb_Sum5 /
    rtb_Px_h);
  ...
  rtb_Sum5 = 1.0 / rt_atan2d_snf(navigator_P.Constant3_Value_o, rtb_Sum5 * cos
    (rtb_SinCos_o1)) * rtb_Gain_k_idx_0;
   ...
   *  Sum: '<S26>/Sum3'
   */
  rtb_Gain_k_idx = ((rtb_xcos + rtb_ysin) - (rtb_DotProduct * rtb_Py_a +
    rtb_Sum5 * rtb_Px_h)) * navigator_P.Gain_Gain_n;
  rtb_Gain_k_idx_0 = ((rtb_dEast * rtb_Px - rtb_Sum1_n) - (rtb_Sum5 * rtb_Py_a -
    rtb_DotProduct * rtb_Px_h)) * navigator_P.Gain_Gain_n;

  /* Sqrt: '<S10>/Sqrt' incorporates:
   *  DotProduct: '<S10>/Dot Product'
   */
  rtb_Gain = sqrt(rtb_Gain_k_idx * rtb_Gain_k_idx + rtb_Gain_k_idx_0 *
                  rtb_Gain_k_idx_0);
   ...
   */
  if (rtb_Gain != 0.0) {
    rtb_Gain_k_idx /= rtb_Gain;
    rtb_Gain_k_idx_0 /= rtb_Gain;
  } else {
    rtb_Gain_k_idx = navigator_P.Constant_Value[0];
    rtb_Gain_k_idx_0 = navigator_P.Constant_Value[1];
  }
  ...
  if (rtb_Gain >= navigator_P.Saturation_UpperSat) {
    ...
    if (rtb_Gain <= navigator_P.Saturation_LowerSat) {
  ...
  /* Product: '<S10>/Product' */
  rtb_Gain_k_idx *= rtb_Gain;
  rtb_xcos = rtb_Gain_k_idx_0 * rtb_Gain;

  /* DataTypeConversion: '<S1>/Data Type Conversion2' incorporates:
   *  Gain: '<S1>/Gain'
   *  Sum: '<S1>/Sum1'
   */
  rtb_VxVyVz_idx = (real32_T)(navigator_P.Gain_Gain * rtb_DataTypeConversion1[5]
    + rtb_Gain_k_idx);
   ...
   */
  rtb_Gain_k_idx = rtb_Py_a / navigator_P.Constant4_Value_d;
   ...
   *  Rounding: '<S46>/Rounding Function1'
   */
  rtb_Py_a -= navigator_P.Gain3_Gain_c * rtb_Gain_k_idx;
  ...
  if (rtb_Sum5 < 0.0) {
    rtb_Gain_k_idx = ceil(rtb_Sum5);
  } else {
    rtb_Gain_k_idx = floor(rtb_Sum5);
  }
   ...
   *  Rounding: '<S46>/Rounding Function'
   */
  rtb_Py_a = (rtb_Py_a - navigator_P.Gain_Gain_nn * rtb_Gain_k_idx) - rtb_Sum5 *
    rt_remd_snf(rtb_Py_a, navigator_P.Constant3_Value_e);
   ...
   */
  rtb_Gain_k_idx = rtb_Sum5 / navigator_P.Constant_Value_m5;
   ...
   *  Rounding: '<S47>/Rounding Function'
   */
  rtb_Sum5 -= navigator_P.Gain_Gain_m * rtb_Gain_k_idx;

  /* Gain: '<S49>/Unit Conversion' incorporates:
   *  Constant: '<S45>/initial_pos'
   *  Sum: '<S45>/Sum1'
   */
  rtb_Gain_k_idx = (rtb_Py_a - navigator_P.initial_pos_Value_j[0]) *
    navigator_P.UnitConversion_Gain_on;
  rtb_Gain_k_idx_0 = (rtb_Sum5 - navigator_P.initial_pos_Value_j[1]) *
    navigator_P.UnitConversion_Gain_on;
  ...
  rtb_DotProduct = sin(rtb_Sum5);

  /* Sum: '<S53>/Sum1' incorporates:
   *  Constant: '<S53>/Constant'
   *  Product: '<S53>/Product1'
   */
  rtb_DotProduct = navigator_P.Constant_Value_b3 - rtb_Py_a * rtb_Py_a *
   ...
   *  Sqrt: '<S50>/sqrt'
   */
  rtb_Px = navigator_P.Constant1_Value_k / sqrt(rtb_DotProduct);
   ...
   */
  rtb_Py_a = rtb_Gain_k_idx / rt_atan2d_snf(navigator_P.Constant2_Value_a,
    (navigator_P.Constant_Value_c4 - rtb_Py_a * rtb_Py_a) * rtb_Px /
    rtb_DotProduct);
  ...
  rtb_Sum5 = 1.0 / rt_atan2d_snf(navigator_P.Constant3_Value_p, rtb_Px * cos
    (rtb_Sum5)) * rtb_Gain_k_idx_0;

  /* Sum: '<S48>/Sum2' incorporates:
   *  Product: '<S48>/x*cos'
   *  Product: '<S48>/y*sin'
   */
  rtb_Px = rtb_Py_a * rtb_dEast + rtb_Sum5 * rtb_DotProduct;
   ...
   *  Product: '<S48>/y*cos'
   */
  rtb_Py_a = rtb_Sum5 * rtb_dEast - rtb_Py_a * rtb_DotProduct;
   ...
   */
  rtb_DotProduct = rt_remd_snf(rtb_DataTypeConversion1[16],
    navigator_P.Constant5_Value_c);

  /* Product: '<S35>/Product2' incorporates:
   *  Constant: '<S35>/Constant4'
   */
  rtb_Gain_k_idx = rtb_DotProduct / navigator_P.Constant4_Value_a;
   ...
   *  Rounding: '<S35>/Rounding Function1'
   */
  rtb_DotProduct -= navigator_P.Gain3_Gain_g * rtb_Gain_k_idx;

  /* Product: '<S35>/Product' incorporates:
   *  Constant: '<S35>/Constant1'
   */
  rtb_dEast = rtb_DotProduct / navigator_P.Constant1_Value_f;

  /* Rounding: '<S35>/Rounding Function' */
  if (rtb_dEast < 0.0) {
    rtb_Gain_k_idx = ceil(rtb_dEast);
  } else {
    rtb_Gain_k_idx = floor(rtb_dEast);
  }
   ...
   *  Rounding: '<S35>/Rounding Function'
   */
  rtb_DotProduct = (rtb_DotProduct - navigator_P.Gain_Gain_o * rtb_Gain_k_idx) -
    rtb_dEast * rt_remd_snf(rtb_DotProduct, navigator_P.Constant3_Value_f);
   ...
   */
  rtb_Gain_k_idx = rtb_dEast / navigator_P.Constant_Value_bl;
   ...
   *  Rounding: '<S36>/Rounding Function'
   */
  rtb_dEast -= navigator_P.Gain_Gain_g * rtb_Gain_k_idx;

  /* Gain: '<S38>/Unit Conversion' incorporates:
   *  Constant: '<S34>/initial_pos'
   *  Sum: '<S34>/Sum1'
   */
  rtb_Gain_k_idx = (rtb_DotProduct - navigator_P.initial_pos_Value_g[0]) *
    navigator_P.UnitConversion_Gain_bh;
  rtb_Gain_k_idx_0 = (rtb_dEast - navigator_P.initial_pos_Value_g[1]) *
    navigator_P.UnitConversion_Gain_bh;
   ...
   *  Constant: '<S43>/f'
   */
  rtb_DotProduct = navigator_P.f_Value_e - navigator_P.Constant_Value_l;
   ...
   *  Sum: '<S44>/Sum1'
   */
  rtb_DotProduct = sqrt(navigator_P.Constant_Value_h - rtb_DotProduct *
                        rtb_DotProduct);
   ...
   */
  rtb_SinCos_o1 = navigator_P.Constant_Value_a2 - rtb_DotProduct *
    rtb_DotProduct * rtb_SinCos_o1 * rtb_SinCos_o1;
   ...
   */
  rtb_DotProduct = rtb_Gain_k_idx / rt_atan2d_snf(navigator_P.Constant2_Value_hi,
    (navigator_P.Constant_Value_kl - rtb_DotProduct * rtb_DotProduct) * rtb_Px_h
    / rtb_SinCos_o1);
  ...
  rtb_dEast = 1.0 / rt_atan2d_snf(navigator_P.Constant3_Value_k, rtb_Px_h * cos
    (rtb_dEast)) * rtb_Gain_k_idx_0;

  /* Sum: '<S37>/Sum2' incorporates:
   *  Product: '<S37>/x*cos'
   *  Product: '<S37>/y*sin'
   */
  rtb_Px_h = rtb_DotProduct * rtb_ysin + rtb_dEast * rtb_SinCos_o1;

  /* Sum: '<S37>/Sum3' incorporates:
   *  Product: '<S37>/x*sin'
   *  Product: '<S37>/y*cos'
   */
  rtb_ysin = rtb_dEast * rtb_ysin - rtb_DotProduct * rtb_SinCos_o1;

  /* Gain: '<S4>/Gain' incorporates:
   *  Sum: '<S1>/Sum3'
   */
  rtb_Gain_k_idx = (rtb_Sum1_n - rtb_Px_h) * navigator_P.Gain_Gain_gl;
  rtb_Gain_k_idx_0 = (rtb_Sum5 - rtb_ysin) * navigator_P.Gain_Gain_gl;
  ...
  if (rtb_Gain != 0.0) {
    ...
    rtb_Gain_k_idx = navigator_P.Constant_Value_a[0];
    rtb_Gain_k_idx_0 = navigator_P.Constant_Value_a[1];
  }
  ...
  if (rtb_Gain >= navigator_P.Saturation_UpperSat_l) {
    rtb_Gain = navigator_P.Saturation_UpperSat_l;
  } else {
    if (rtb_Gain <= navigator_P.Saturation_LowerSat_d) {
      rtb_Gain = navigator_P.Saturation_LowerSat_d;
    }
  }
  ...
  navigator_Y.Out[3] = (real32_T)(navigator_P.Gain_Gain *
    rtb_DataTypeConversion1[6] + rtb_xcos);
  navigator_Y.Out[4] = (real32_T)((-(rtb_DataTypeConversion1[2] +
    navigator_P.Constant_Value_f1) - (-(rtb_DataTypeConversion1[11] +
    navigator_P.Constant_Value_kn))) + navigator_P.Vz1_Value);
  navigator_Y.Out[5] = (real32_T)rtb_Gain_k_idx;
  navigator_Y.Out[6] = (real32_T)(rtb_Gain_k_idx_0 * rtb_Gain);
  navigator_Y.Out[7] = (real32_T)(rtb_DataTypeConversion1[18] -
  ...
  navigator_Y.Out[11] = (real32_T)rtb_ysin;
