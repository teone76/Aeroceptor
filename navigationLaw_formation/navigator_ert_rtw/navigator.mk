...
## Generated on : Thu Apr 23 12:25:28 2015
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\GIANLU~1\Desktop\dottorato\Simulink\navigationLaw_formation
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = C89/C90 (ANSI)
MODELREF_LINK_RSPFILE_NAME = navigator_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = navigator_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\navigator.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\navigator_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=navigator -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\navigator_ert_rtw\navigator.cpp $(START_DIR)\navigator_ert_rtw\navigator_data.cpp $(START_DIR)\navigator_ert_rtw\rtGetInf.cpp $(START_DIR)\navigator_ert_rtw\rtGetNaN.cpp $(START_DIR)\navigator_ert_rtw\rt_nonfinite.cpp

MAIN_SRC = $(START_DIR)\navigator_ert_rtw\ert_main.cpp
...
OBJS = navigator.obj navigator_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(START_DIR)\navigator_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\navigator_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
