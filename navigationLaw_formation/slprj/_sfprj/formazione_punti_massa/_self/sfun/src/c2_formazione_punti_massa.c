...
#include <stddef.h>
#include "blas.h"
#include "formazione_punti_massa_sfun.h"
#include "c2_formazione_punti_massa.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "formazione_punti_massa_sfun_debug_macros.h"
...
static void initialize_c2_formazione_punti_massa
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance);
static void initialize_params_c2_formazione_punti_massa
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance);
static void enable_c2_formazione_punti_massa
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance);
static void disable_c2_formazione_punti_massa
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_formazione_punti_massa
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_formazione_punti_massa
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance);
static void set_sim_state_c2_formazione_punti_massa
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_formazione_punti_massa
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance);
static void sf_c2_formazione_punti_massa
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance);
static void initSimStructsc2_formazione_punti_massa
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_formazione_punti_massaInstanceStruct
  *chartInstance, const mxArray *c2_y, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_formazione_punti_massaInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_formazione_punti_massaInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[2]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_formazione_punti_massaInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_formazione_punti_massaInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_formazione_punti_massa, const
  char_T *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_formazione_punti_massaInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_formazione_punti_massaInstanceStruct
  *chartInstance);
  ...
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_formazione_punti_massa = 0U;
}
  ...
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_formazione_punti_massa;
   ...
   *c2_st)
{
  ...
  *c2_y = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)),
    "y");
  chartInstance->c2_is_active_c2_formazione_punti_massa = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_formazione_punti_massa");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_formazione_punti_massa(chartInstance);
  ...
  (SFc2_formazione_punti_massaInstanceStruct *chartInstance)
{
  ...
  c2_hb_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_DATA_RANGE_CHECK(*c2_hb_y, 2U);
  ...
  *c2_hb_y = c2_y;
  ...
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_formazione_punti_massaMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_formazione_punti_massaInstanceStruct *chartInstance;
  chartInstance = (SFc2_formazione_punti_massaInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_formazione_punti_massa_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_formazione_punti_massa), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_formazione_punti_massa);
  return c2_y;
}
...
void sf_c2_formazione_punti_massa_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2960582009U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(724714613U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1030213336U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1329297450U);
}

mxArray *sf_c2_formazione_punti_massa_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Z2ORqkAzDDn1oexrPhDSMC");
...
mxArray *sf_c2_formazione_punti_massa_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_formazione_punti_massa_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_formazione_punti_massa(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_formazione_punti_massa\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_formazione_punti_massa_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_formazione_punti_massaInstanceStruct *chartInstance;
    chartInstance = (SFc2_formazione_punti_massaInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_formazione_punti_massaMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_formazione_punti_massaMachineNumber_,
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,471);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _formazione_punti_massaMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "mo8iR1UgeATPfINaqLHviC";
}

static void sf_opaque_initialize_c2_formazione_punti_massa(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_formazione_punti_massaInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_formazione_punti_massa
    ((SFc2_formazione_punti_massaInstanceStruct*) chartInstanceVar);
  initialize_c2_formazione_punti_massa
    ((SFc2_formazione_punti_massaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_formazione_punti_massa(void *chartInstanceVar)
{
  enable_c2_formazione_punti_massa((SFc2_formazione_punti_massaInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_formazione_punti_massa(void *chartInstanceVar)
{
  disable_c2_formazione_punti_massa((SFc2_formazione_punti_massaInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_formazione_punti_massa(void *chartInstanceVar)
{
  sf_c2_formazione_punti_massa((SFc2_formazione_punti_massaInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_formazione_punti_massa
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_formazione_punti_massa
    ((SFc2_formazione_punti_massaInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_formazione_punti_massa();/* state var info */
...
extern void sf_internal_set_sim_state_c2_formazione_punti_massa(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_formazione_punti_massa
    ((SFc2_formazione_punti_massaInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_formazione_punti_massa
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_formazione_punti_massa(S);
}

static void sf_opaque_set_sim_state_c2_formazione_punti_massa(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_formazione_punti_massa(S, st);
}

static void sf_opaque_terminate_c2_formazione_punti_massa(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_formazione_punti_massaInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_formazione_punti_massa_optimization_info();
    }

    finalize_c2_formazione_punti_massa
      ((SFc2_formazione_punti_massaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_formazione_punti_massa
    ((SFc2_formazione_punti_massaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_formazione_punti_massa(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_formazione_punti_massa
      ((SFc2_formazione_punti_massaInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_formazione_punti_massa(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_formazione_punti_massa_optimization_info();
  ...
  ssSetChecksum0(S,(3410534201U));
  ssSetChecksum1(S,(1862772896U));
  ssSetChecksum2(S,(1408228632U));
  ssSetChecksum3(S,(2871264396U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_formazione_punti_massa(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_formazione_punti_massa(SimStruct *S)
{
  SFc2_formazione_punti_massaInstanceStruct *chartInstance;
  chartInstance = (SFc2_formazione_punti_massaInstanceStruct *)utMalloc(sizeof
    (SFc2_formazione_punti_massaInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_formazione_punti_massaInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_formazione_punti_massa;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_formazione_punti_massa;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_formazione_punti_massa;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_formazione_punti_massa;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_formazione_punti_massa;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_formazione_punti_massa;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_formazione_punti_massa;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_formazione_punti_massa;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_formazione_punti_massa;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_formazione_punti_massa;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_formazione_punti_massa;
...
void c2_formazione_punti_massa_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_formazione_punti_massa(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_formazione_punti_massa(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_formazione_punti_massa(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_formazione_punti_massa_method_dispatcher.\n"
