...
void printAllData()
{
  ...
  Serial.print(", "); 
  Serial.print(navigator_Y.Out[10] - navigator_Y.Out[8], 7); 
  Serial.print(", ");  
  Serial.print(navigator_Y.Out[11] - navigator_Y.Out[9], 7); 
  Serial.print(", ");   
  Serial.print(navigator_Y.Out[12] - navigator_Y.Out[8], 7); 
  Serial.print(", ");    
  Serial.println(navigator_Y.Out[13] - navigator_Y.Out[9], 7);     
  /*
   Serial.print(millis()); 
   Serial.print(", ");  
