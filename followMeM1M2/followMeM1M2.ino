...
void loop() { 
  ...
  { 
      // Set model inputs  
  navigator_U.In[0] = multirotor_1.getLatitude();
  navigator_U.In[1] = multirotor_1.getLongitude();
  navigator_U.In[2] = multirotor_1.getRelativeAltitude();
  navigator_U.In[3] = multirotor_1.getGroundSpeed();
  navigator_U.In[4] = multirotor_1.getHeading();

  navigator_U.In[5] = gps.course_to(multirotor_2.getLatitude(), multirotor_2.getLongitude(), multirotor_1.getLatitude(), multirotor_1.getLongitude());
  navigator_U.In[6] = gps.distance_between(multirotor_2.getLatitude(), multirotor_2.getLongitude(), multirotor_1.getLatitude(), multirotor_1.getLongitude());
  
  navigator_U.In[7] = multirotor_2.getLatitude();
  navigator_U.In[8] = multirotor_2.getLongitude();  
  navigator_U.In[9] = multirotor_2.getRelativeAltitude();
  navigator_U.In[10] = multirotor_2.getGroundSpeed();
  navigator_U.In[11] = multirotor_2.getHeading();  
  
  navigator_U.In[12] = multirotor_2.getVx();
  navigator_U.In[13] = multirotor_2.getVy();
...
//  multirotor_1.setRifLongitude(navigator_Y.Out[1]);
  multirotor_2.setRifRelAltitude(navigator_Y.Out[2]);
  multirotor_2.setRifVx(navigator_Y.Out[0] /*+ rover.getVx()*/);   ///////////////////////////////////////
  multirotor_2.setRifVy(navigator_Y.Out[1] /*+ rover.getVy()*/);   ///////////////////////////////////////
...
void printAllData()
{
  ...
  Serial.print(", "); 
  Serial.print(navigator_Y.Out[2], 7);    
