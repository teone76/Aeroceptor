...
static void initialize_c2_simulatoreWONDERS(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance);
static void initialize_params_c2_simulatoreWONDERS
  (SFc2_simulatoreWONDERSInstanceStruct *chartInstance);
static void enable_c2_simulatoreWONDERS(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance);
static void disable_c2_simulatoreWONDERS(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_simulatoreWONDERS
  (SFc2_simulatoreWONDERSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_simulatoreWONDERS
  (SFc2_simulatoreWONDERSInstanceStruct *chartInstance);
static void set_sim_state_c2_simulatoreWONDERS
  (SFc2_simulatoreWONDERSInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_simulatoreWONDERS(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance);
static void sf_c2_simulatoreWONDERS(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance);
static void initSimStructsc2_simulatoreWONDERS
  (SFc2_simulatoreWONDERSInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance, const mxArray *c2_y, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[2]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_simulatoreWONDERS, const
  char_T *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_simulatoreWONDERSInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_simulatoreWONDERS = 0U;
}
  ...
  (SFc2_simulatoreWONDERSInstanceStruct *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_simulatoreWONDERS;
  ...
  (SFc2_simulatoreWONDERSInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_y = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)),
    "y");
  chartInstance->c2_is_active_c2_simulatoreWONDERS = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_simulatoreWONDERS");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_simulatoreWONDERS(chartInstance);
  ...
  *chartInstance)
{
  ...
  int32_T c2_i11;
  static char_T c2_cv6[15] = { 'M', 'a', 'r', 'k', 'e', 'r', 'F', 'a', 'c', 'e',
    'C', 'o', 'l', 'o', 'r' };
  ...
  c2_y_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_DATA_RANGE_CHECK(*c2_y_y, 2U);
  ...
  for (c2_i11 = 0; c2_i11 < 15; c2_i11++) {
    c2_u_u[c2_i11] = c2_cv6[c2_i11];
  }

  c2_v_y = NULL;
  sf_mex_assign(&c2_v_y, sf_mex_create("y", c2_u_u, 10, 0U, 1U, 0U, 2, 1, 15),
                FALSE);
  ...
  c2_w_y = NULL;
  sf_mex_assign(&c2_w_y, sf_mex_create("y", c2_v_u, 0, 0U, 1U, 0U, 2, 1, 3),
                FALSE);
  sf_mex_call_debug("plot", 0U, 11U, 14, c2_m_y, 14, c2_n_y, 14, c2_o_y, 14,
                    c2_p_y, 14, c2_q_y, 14, c2_r_y, 14, c2_s_y, 14, c2_t_y, 14,
                    c2_u_y, 14, c2_v_y, 14, c2_w_y);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 14);
  c2_w_u = 0.033333333333333333;
  c2_x_y = NULL;
  sf_mex_assign(&c2_x_y, sf_mex_create("y", &c2_w_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_call_debug("pause", 0U, 1U, 14, c2_x_y);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -14);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_simulatoreWONDERSInstanceStruct *chartInstance;
  chartInstance = (SFc2_simulatoreWONDERSInstanceStruct *)chartInstanceVoid;
  ...
  *c2_inData)
{
  ...
  for (c2_i13 = 0; c2_i13 < 2; c2_i13++) {
    c2_b_inData[c2_i13] = (*(real_T (*)[2])c2_inData)[c2_i13];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i16 = 0; c2_i16 < 2; c2_i16++) {
    (*(real_T (*)[2])c2_outData)[c2_i16] = c2_y[c2_i16];
  }

  sf_mex_destroy(&c2_mxArrayInData);
}

const mxArray *sf_c2_simulatoreWONDERS_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_simulatoreWONDERS), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_simulatoreWONDERS);
  return c2_y;
}
...
void sf_c2_simulatoreWONDERS_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2077270334U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2034334181U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2181469967U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(921161558U);
}

mxArray *sf_c2_simulatoreWONDERS_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("PCqhV7Ka7K4UqFOu9IfVVC");
...
mxArray *sf_c2_simulatoreWONDERS_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_simulatoreWONDERS_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_simulatoreWONDERS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_simulatoreWONDERS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_simulatoreWONDERS_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_simulatoreWONDERSInstanceStruct *chartInstance;
    chartInstance = (SFc2_simulatoreWONDERSInstanceStruct *) ((ChartInfoStruct *)
...
{
  return "NRShtXxOTBEOxOZCOvQN9B";
}

static void sf_opaque_initialize_c2_simulatoreWONDERS(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_simulatoreWONDERSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_simulatoreWONDERS((SFc2_simulatoreWONDERSInstanceStruct*)
    chartInstanceVar);
  initialize_c2_simulatoreWONDERS((SFc2_simulatoreWONDERSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_simulatoreWONDERS(void *chartInstanceVar)
{
  enable_c2_simulatoreWONDERS((SFc2_simulatoreWONDERSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_simulatoreWONDERS(void *chartInstanceVar)
{
  disable_c2_simulatoreWONDERS((SFc2_simulatoreWONDERSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_simulatoreWONDERS(void *chartInstanceVar)
{
  sf_c2_simulatoreWONDERS((SFc2_simulatoreWONDERSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_simulatoreWONDERS(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_simulatoreWONDERS
    ((SFc2_simulatoreWONDERSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_simulatoreWONDERS();/* state var info */
...
extern void sf_internal_set_sim_state_c2_simulatoreWONDERS(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_simulatoreWONDERS((SFc2_simulatoreWONDERSInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_simulatoreWONDERS(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_simulatoreWONDERS(S);
}

static void sf_opaque_set_sim_state_c2_simulatoreWONDERS(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_simulatoreWONDERS(S, st);
}

static void sf_opaque_terminate_c2_simulatoreWONDERS(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_simulatoreWONDERSInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_simulatoreWONDERS_optimization_info();
    }

    finalize_c2_simulatoreWONDERS((SFc2_simulatoreWONDERSInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_simulatoreWONDERS((SFc2_simulatoreWONDERSInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_simulatoreWONDERS(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_simulatoreWONDERS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2129422738U));
  ssSetChecksum1(S,(2956506728U));
  ssSetChecksum2(S,(2479769359U));
  ssSetChecksum3(S,(1278647234U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_simulatoreWONDERS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_simulatoreWONDERS(SimStruct *S)
{
  SFc2_simulatoreWONDERSInstanceStruct *chartInstance;
  chartInstance = (SFc2_simulatoreWONDERSInstanceStruct *)utMalloc(sizeof
    (SFc2_simulatoreWONDERSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_simulatoreWONDERSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_simulatoreWONDERS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_simulatoreWONDERS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_simulatoreWONDERS;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_simulatoreWONDERS;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_simulatoreWONDERS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_simulatoreWONDERS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_simulatoreWONDERS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_simulatoreWONDERS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_simulatoreWONDERS;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_simulatoreWONDERS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_simulatoreWONDERS;
...
void c2_simulatoreWONDERS_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_simulatoreWONDERS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_simulatoreWONDERS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_simulatoreWONDERS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_simulatoreWONDERS_method_dispatcher.\n"
